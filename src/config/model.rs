...
pub struct UiConfig {
    ...
    /// Render tab-bar tabs as pills with nerd-font half-circle end caps.
    /// Requires a font that covers U+E0B4/U+E0B6 (powerline extras). Default: false.
    pub tab_pills: bool,
...
"#;
    ...
    fn pane_appearance_defaults_and_parse() {
        ...
        assert!(!default_config.ui.tab_pills);
